...
go
CREATE USER edwardbs FROM LOGIN edwardbs; exec sp_addrolemember 'db_owner', 'edwardbs'; 
go
CREATE USER brownekj FROM LOGIN brownekj; exec sp_addrolemember 'db_owner', 'brownekj'; 
go
